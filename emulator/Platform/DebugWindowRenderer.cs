...
namespace JustinCredible.GalagaEmu
{
    public static class DebugWindowRenderer
    {
        ...
        public static void Render(IntPtr surface, DebuggerState state, string inputString, List<string> fileList, GalagaPCB pcb, bool showAnnotatedDisassembly)
        {
        ...
        private static void RenderCpuStateAndDisassembly(IntPtr surface, DebuggerState state, GalagaPCB pcb, bool showAnnotatedDisassembly)
        {
